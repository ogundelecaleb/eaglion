...
const Service = () => {
  return (
    <div className="px-[16px] md:px-[30px] lg:px-[80px]  ">
      <h2 className="text-center lg:text-[70px] md:text-[40px] text-[24px] font-bold tracking-wider">
        How Can We Help You?
      </h2>{" "}
      <p className="text-[12px] md:text-[16px] text-center mb-[25px]">
        We offer diverse servicxes, a few are listed below.
      </p>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-[20px]">
        <div className="text-center relative shadow-lg py-[30px] md:py-[40px] px-[14px]  rounded-lg text-black border border-[#04234F]">
